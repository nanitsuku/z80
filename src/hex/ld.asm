;                       ;        PC A  B  C  D  E  F  H  L  A' B' C' D' E' F' H' L' SP   IX   IY   R  I  IFF IFF2
        ...
        LD A,(08303H)   ; expect PC 53 NC NC NC NC NC NC NC NC NC NC NC NC NC NC NC NC   NC   NC   NC NC NC  NC
        LD A,(08304H)   ; expect PC 52 NC NC NC NC NC NC NC NC NC NC NC NC NC NC NC NC   NC   NC   NC NC NC  NC
        LD (8404H),A    ; expect PC NC NC NC NC NC NC NC NC NC NC NC NC NC NC NC NC NC   NC   NC   NC NC NC  NC

        LD HL,(8404H)   ; expect PC NC NC NC NC NC NC 00 52 NC NC NC NC NC NC NC NC NC   NC   NC   NC NC NC  NC
